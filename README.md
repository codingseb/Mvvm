...
Some useful stuffs for better Mvvm in WPF
...
* `IRelayCommand` (That inherit from ICommand) to call RaiseCanExecuteChanged() from any where
  * `RelayCommand`
  * `RelayCommand<T>`
* Some useful methods extensions to navigate in both VisualTree and LogicalTree easily from C#
...
*You can also use [PropertyChanged.Fody](https://github.com/Fody/PropertyChanged) to simplify more your Mvvm code*
